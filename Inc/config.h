...
/*************************************************************************************************/
  ...
  #define OVERRIDE_V_BATPIN                   PA4  //A0 // instead of A3    // Analog PIN 3
  ...
  #define OVERRIDE_BUZZERPIN_PINMODE          pinMode (PA5, OUTPUT);  //pinMode (A2, OUTPUT); // use A2 instead of d8
  #define OVERRIDE_BUZZERPIN_ON               digitalWrite(PA5, HIGH); //PORTC |= 1<<2 //PORTB |= 1;
  #define OVERRIDE_BUZZERPIN_OFF              digitalWrite(PA5, LOW); //PORTC &= ~(1<<2); //PORTB &= ~1;
