...
//	ICM20602_Writebyte(GYRO_CONFIG, 0x10); // Gyro sensitivity 1000 dps(bit4:3-10), FCHOICE (bit1:0-00)
	HAL_Delay(50);

	// ACCEL_CONFIG 0x1C
	ICM20602_Writebyte(ACCEL_CONFIG, 0x18); // Acc sensitivity 16g
//	ICM20602_Writebyte(ACCEL_CONFIG, 0x10); // Acc sensitivity 8g
	HAL_Delay(50);
